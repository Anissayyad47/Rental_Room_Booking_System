import style from './SearchBar_copy.module.css';
...
export default function SearchBar_copy() {
...
// Rooms and guest handling
  ...
  return (
    <div className={style.search_bar_container}>
      ...
      <CiCalendarDate size={30} className={style.dataIcon1}></CiCalendarDate>
      <DatePicker
        selected={checkIn}
      ...
      />
      <CiCalendarDate size={30} className={style.dataIcon2}></CiCalendarDate>
      </div>
...
{/* Guest And Rooms */}
      <div className={style.guests_rooms_container}>
        ...
        {showRoomGuestDropdown && (
          <div className={style.add_rooms_guests}>
            <div>
