    ...
    export default function LoginOwner({ setLogin }) {
    ...
    console.log("Login details:", loginData);
        ...
        try {
            ...
            "http://localhost:8080/api/auth/seller/login",
            loginData
            );
    ...
    const handleSubmit=async (e)=>{
        ...
        e.preventDefault();
    await axios.post("http://localhost:8080/api/auth/seller/register", userData)
